    ...
    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
      ...
      <div className="p-6">
        ...
        <div className="text-center mt-8">
          <a
            href={`https://wa.me/918877896889?text=${encodeURIComponent(`Hi ASR! I just saw the 25-year comparison. My current bill is ₹${monthlyBill}/month. I want to save ${formatLakh(costs.savings)} over 25 years. Please schedule a FREE site survey!`)}`}
            target="_blank"
