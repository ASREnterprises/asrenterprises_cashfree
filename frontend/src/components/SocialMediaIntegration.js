  ...
  const generateAIPost = async (type) => {
    ...
    try {
      ...
      const fallbackContent = {
        promotion: "🌞 Switch to Solar with ASR Enterprises! Get up to ₹78,000 govt subsidy under PM Surya Ghar Yojana. 25-year warranty + 5 years FREE maintenance! 📞 Call: 8877896889 #SolarPower #BiharSolar #PMSuryaGhar",
        project: "✨ Another successful installation in Bihar! Our team just completed a 5kW rooftop solar system. Save 90% on electricity bills! Contact us for a FREE site survey. 📱 WhatsApp: 8877896889 #SolarInstallation #CleanEnergy",
        ...
        scheme: "📢 Important Update! PM Surya Ghar Muft Bijli Yojana offers up to ₹78,000 subsidy for rooftop solar. Don't miss this opportunity! ASR Enterprises can help you apply. 📞 8877896889 #GovtScheme #SolarSubsidy"
      };
