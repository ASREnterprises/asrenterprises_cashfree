      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold text-white">Festival Posts Management</h1>
          </div>
          <button
          ...
          <div className="bg-gray-800 rounded-xl p-6 mb-8">
            ...
            <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-4">
              ...
              <textarea
                ...
                className="bg-gray-700 text-white px-4 py-3 rounded-lg md:col-span-2"
                rows={3}
                required
              />
              <div className="md:col-span-2 flex space-x-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 disabled:opacity-50 flex-1"
                >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {festivals.map((festival) => (
            <div key={festival.id} className="bg-gradient-to-br from-pink-600 to-purple-700 rounded-xl p-6 text-white">
              ...
              {festival.is_active && (
                <span className="inline-block mt-4 bg-green-500 text-white text-xs px-2 py-1 rounded">Active</span>
              )}
            </div>
          ))}
        </div>
        ...
        {festivals.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400">No festival posts created yet. Use templates above or click "Create Post".</p>
          </div>
        )}
      </div>
    </div>
