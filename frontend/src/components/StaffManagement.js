      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold text-white">AI Staff Management</h1>
          </div>
          <button
          ...
          <div className="bg-gray-800 rounded-xl p-6 mb-8">
            ...
            <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 disabled:opacity-50 md:col-span-2"
              >
        ...
        {showTaskForm && selectedStaff && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-xl p-6 max-w-md w-full">
              <h2 className="text-xl font-bold text-white mb-4">Assign Task to {selectedStaff.name}</h2>
              <form onSubmit={handleAssignTask} className="space-y-4">
                <input
                  ...
                  className="bg-gray-700 text-white px-4 py-3 rounded-lg w-full"
                  required
                />
                <textarea
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    className="bg-gray-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-500"
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div key={member.id} className="bg-gray-800 rounded-xl p-6">
              ...
              <div className="space-y-2 text-sm text-gray-400 mb-4">
                ...
                {member.reportingTo && (
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-300">{member.reportingTo}</span>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2">
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white py-2 rounded-lg text-sm font-medium hover:bg-blue-700 flex items-center justify-center space-x-1"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-green-600 text-white py-2 rounded-lg text-sm font-medium hover:bg-green-700 flex items-center justify-center space-x-1"
                  >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 rounded-lg text-sm font-medium hover:from-purple-700 hover:to-pink-700 flex items-center justify-center space-x-2 disabled:opacity-50"
                >
              ...
              {member.ai_performance_insights && (
                <div className="mt-4 bg-purple-600 bg-opacity-20 border border-purple-600 rounded-lg p-3">
                  ...
                  <p className="text-gray-300 text-xs">{member.ai_performance_insights.substring(0, 150)}...</p>
                </div>
              )}
            </div>
          ))}
        ...
        {staff.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400">No staff members added yet. Click "Add Staff" to get started.</p>
          </div>
        )}
      </div>
    </div>
