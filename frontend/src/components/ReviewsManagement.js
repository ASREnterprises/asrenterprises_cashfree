      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold text-white">Customer Reviews Management</h1>
          </div>
          <button
        ...
        {showForm && (
          <div className="bg-gray-800 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-bold text-white mb-4">Add Customer Review</h2>
          ...
          {reviews.map((review) => (
            <div key={review.id} className="bg-gray-800 rounded-xl p-6">
              ...
              {review.system_installed && (
                <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded">{review.system_installed}</span>
              )}
            </div>
          ))}
        </div>
        ...
        {reviews.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400">No reviews added yet. Click "Add Review" to get started.</p>
          </div>
        )}
      </div>
    </div>
