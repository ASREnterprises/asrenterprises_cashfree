      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold text-white">Work Photos Management</h1>
          </div>
          <button
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {photos.map((photo) => (
            <div key={photo.id} className="bg-gray-800 rounded-xl overflow-hidden">
              <img
                src={photo.image_url}
                alt={photo.title}
              ...
              <div className="p-4">
                ...
                <p className="text-gray-400 text-sm mb-3">{photo.description}</p>
                <div className="flex items-center justify-between">
                  <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded">{photo.system_size || "Solar System"}</span>
                  <button
        ...
        {photos.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400">No photos uploaded yet. Click "Add Photo" to get started.</p>
          </div>
        )}
      </div>
    </div>
