  ...
  return (
    <div className="min-h-screen bg-[#F7FAFC]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Company Header - Premium Dark Hero */}
        <div className="text-center mb-16 py-16 -mt-16 -mx-4 sm:-mx-6 lg:-mx-8 px-4 relative overflow-hidden" style={{
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-extrabold text-white mb-4 font-[Poppins]">Contact Us</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          {/* Map / Image Section */}
          <div className="space-y-6">
            {/* Company Info Card - Premium Dark Theme */}
            <div className="rounded-3xl shadow-2xl p-8 text-white relative overflow-hidden" style={{
              background: 'radial-gradient(ellipse at 50% 0%, #0B3C5D 0%, #071A2E 100%)'
            }}>
              <div className="absolute inset-0 opacity-10" style={{
                backgroundImage: `
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                    ...
                    <div className="text-gray-300 text-sm">Capacity</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
