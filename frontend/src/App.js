...
const AdminSecuritySettings = lazy(() => import("@/components/AdminSecuritySettings").then(m => ({ default: m.AdminSecuritySettings })));
const CriticalMonitor = lazy(() => import("@/components/CriticalMonitor").then(m => ({ default: m.CriticalMonitor })));
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                {!otpSent && !otpVerified && (
                  <>
                    ...
                    {formData.phone && formData.phone.length >= 10 && (
                      <p className="text-amber-600 text-xs mt-1">OTP will be sent to your WhatsApp (or SMS if unavailable)</p>
                    )}
                  </>
                )}
                ...
                {otpSent && !otpVerified && (
                  <>
                    <div className="bg-green-50 border border-green-200 text-green-800 px-3 py-2 rounded-lg text-sm mb-2">
                      OTP sent to <strong>+91 {formData.phone}</strong> via WhatsApp / SMS
                    </div>
                    <div className="flex gap-2">
                      <input 
                        type="text" 
    ...
    <BrowserRouter>
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/admin/security-otp" element={
            <ProtectedRoute>
              <AdminSecuritySettings />
            </ProtectedRoute>
          } />
          <Route path="/admin/critical-monitor" element={
            <ProtectedRoute>
              <CriticalMonitor />
            </ProtectedRoute>
          } />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {otpSent && !otpVerified && (
                  <>
                    <div className="bg-green-500/20 border border-green-500/30 text-green-300 px-3 py-2 rounded-lg text-sm mb-2">
                      OTP sent to <strong>+91 {formData.phone}</strong> via WhatsApp / SMS
                    </div>
                    <div className="flex gap-2">
                      <input
